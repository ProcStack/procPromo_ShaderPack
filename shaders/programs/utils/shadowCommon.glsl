...
const float shadowThreshold_Entity = shadowThreshold*.05;
...
const float shadowThreshBase = 0.0000025; // Bias near to Camera
const float shadowThreshBase_Entity = 0.00015; // gbuffers_entities.glsl
const float shadowThreshDist = 0.000013; // Bias far from Camera
const float shadowThreshDist_Entity = 0.00035; // Bias far from Camera
